...
import { useAppTheme, ThemeName, FontSizeName } from '../context/ThemeContext';
...
const FONT_OPTIONS: { key: FontSizeName; label: string; size: number }[] = [
  { key:'small', label:'Pequeño', size:13 },
  { key:'medium', label:'Mediano', size:16 },
  { key:'large', label:'Grande', size:20 },
];
export function SettingsScreen() {
  const { colors, scale, theme, fontSize, setTheme, setFontSize } = useAppTheme();
  return (
